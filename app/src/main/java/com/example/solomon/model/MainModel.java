package com.example.solomon.model;

import com.example.solomon.presenter.IMainPresenter;
        ...
        asyncHttpClient.get("http://www.weather.com.cn/adat/sk/101010100.html",
                new JsonHttpResponseHandler(){
                    ...
                    public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                        ...
                        mIMainPresenter.loadDataFailure(statusCode, headers, responseString, throwable);
                    }
                });
